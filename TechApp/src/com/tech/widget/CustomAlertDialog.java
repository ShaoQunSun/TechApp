...
public class CustomAlertDialog implements DialogInterface.OnClickListener {
	...
	public static interface DialogListener {
		...
		public void onClick(DialogInterface DialogListn, int which, int key, View view);
	}
	...
	private static AlertDialog.Builder builder(Context context, String title, String message, int icon) {
	...
	private static AlertDialog.Builder builder(Context context, String title, int message, int icon, int key, View view, int positive, int nagetive, DialogListener listener) {

		return builder(context, title, context.getResources().getString(message), icon, key, view, positive, nagetive, listener);
	}

	private static AlertDialog.Builder builder(Context context, String title, String message, int icon, int key, View view, int positive, int nagetive, DialogListener listener) {
	...
	private static AlertDialog.Builder builder(Context context, String title, String message, int icon, int key, View view, String positive, int nagetive, DialogListener listener) {
	...
	private static AlertDialog.Builder builder(Context context, int title, int message) {
	...
	private static AlertDialog.Builder builder(Context context, int title, int message, int icon) {
	...
	private static AlertDialog.Builder builder(Context context, int title, int message, int icon, int key, View view, int positive, int nagetive, DialogListener listener) {
	...
	public static void showAlertDialog(Context context, int key, int title, int message, int icon, int positive, DialogListener listener) {

		builder(context, title, message, icon, key, null, positive, -1, listener).show();
	}

	public static AlertDialog showAlertDialog(Context context, int key, int title, int message, int icon, int positive, int nagetive, DialogListener listener) {

		return builder(context, title, message, icon, key, null, positive, nagetive, listener).show();
	}

	public static AlertDialog showAlertDialog(Context context, int key, String title, int message, int icon, int positive, int nagetive, DialogListener listener) {

		return builder(context, title, message, icon, key, null, positive, nagetive, listener).show();
	}

	public static AlertDialog showAlertDialog(Context context, int key, String title, String message, int icon, int positive, int nagetive, DialogListener listener) {
	 ...
	 * @return
	 */
	public static AlertDialog showAlertDialogModel(Context context, int key, int title, int message, int icon, int positive, int nagetive, DialogListener listener) {
	...
	public static AlertDialog showAlertDialog(Context context, int key, int title, int message, int icon, View view, int positive, DialogListener listener) {

		return builder(context, title, message, icon, key, view, positive, -1, listener).show();
	}

	public static AlertDialog showAlertDialog(Context context, int key, int title, int message, int icon, View view, int positive, int nagetive, DialogListener listener) {
