...
import com.tech.R;
import com.tech.widget.DialogUtil;
 ...
 * @date 2011-10-9
 */
public abstract class ActivityBase extends SherlockFragmentActivity implements IActivity {
	...
	public boolean onCreateOptionsMenu(com.actionbarsherlock.view.Menu menu) {
		...
		if (!mbMenuShown)
			return true;
		// menu.add(0, MENU_EXIT, MENU_EXIT, getString(R.string.exit)).setIcon(R.drawable.menu_exit);
